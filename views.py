...
app.config['INITIAL_FILE_UPLOADS'] = 'C:/Users/91952/PycharmProjects/Image_watermarking_app/app/static/uploads'
...
def index():
    ...
    if request.method == "POST":
        ...
        if option == 'logo_watermark':
            ...
            full_filename = 'C:/Users/91952/PycharmProjects/Image_watermarking_app/app/static/uploads/image.png'
            return render_template('index.html', full_filename=full_filename)

        else:
            text_mark = request.form['text_mark']

            cv2.putText(image_logow, text=text_mark, org=(w_image - 1000, h_image - 10),
                        fontFace=cv2.FONT_HERSHEY_COMPLEX, fontScale=5.5,
